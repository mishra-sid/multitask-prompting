...
class Trainer:
    ...
    def train(self, train_dataloader, valid_dataloader):
        ...
        optimizer_grouped_parameters2 = [ {'params': [p for name, p in self.model.template.named_parameters() if 'raw_embedding' not in name]},{'params': self.model.verbalizer.group_parameters_1},{'params': self.model.verbalizer.group_parameters_2}] # note that you have to remove the raw_embedding manually from the optimization
