...
def get_uniq_str(args):
    return f"model-{args.model}_plm_path-{args.base_plm_path}_plm-frozen-{args.tune_plm}_verbalizer_init-{args.verbalizer_init}_prompt_text-{args.prompt_num_soft_tokens}"
